<form class="form-inline mr-auto" action="<?php echo e(route('admin.users')); ?>">
    ...
    <!-- <div class="search-element">
        <input class="form-control" value="<?php echo e(Request::get('query')); ?>" name="query" type="search" placeholder="Search"
...
<?php /**PATH D:\xampp\htdocs\rpa-panel\resources\views/admin/partials/topnav.blade.php ENDPATH**/ ?>