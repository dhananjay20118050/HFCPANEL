      ...
      <div class="col-12">
         ...
         <div class="card">
            ...
            <form id="apps_edit_form">
                ...
                <input id="aid" name="aid" type="hidden" value="<?php echo e($apps->id); ?>">
	            <div class="card-body">
	               <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Name</label> 
                    <div class="col-sm-12 col-md-7"><input  id="aname" name="aname" type="text" placeholder="Name of the Apps" value="<?php echo e($apps->name); ?>" class="form-control required"></div>
                 </div>
                 <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">DB Username</label> 
                    <div class="col-sm-12 col-md-7"><input id="adbusername" name="adbusername" type="text" placeholder="DB Username" value="<?php echo e($apps->db_username); ?>" class="form-control required"></div>
                 </div>
                 <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">DB Password</label> 
                    <div class="col-sm-12 col-md-7"><input id="adbpassword" name="adbpassword" type="password" placeholder="DB Password" value="<?php echo e($apps->db_password); ?>" class="form-control required"></div>
                 </div>
                 
                 <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">DB Host</label> 
                    <div class="col-sm-12 col-md-7"><input id="adbhost" name="adbhost"  type="text" placeholder="DB Host" value="<?php echo e($apps->db_host); ?>" class="form-control required"></div>
                 </div>
                 <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">DB Port</label> 
                    <div class="col-sm-12 col-md-7"><input id="adbport" name="adbport"  type="text" placeholder="DB Port" value="<?php echo e($apps->db_port); ?>" class="form-control required"></div>
                 </div>
                 <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">DB Name</label> 
                    <div class="col-sm-12 col-md-7"><input id="adbname" name="adbname"  type="text" placeholder="DB Name" value="<?php echo e($apps->db_name); ?>" class="form-control required"></div>
                 </div>
	               <div class="form-group row mb-4">
  ...
  $('#apps_edit_form').submit(function(e) {
    ...
    /*else if (adbpassword.length < 1) {
      ...
      $('#adbname').addClass('is-invalid');
		...
		var url = "<?php echo e(route('admin.updateapps', ':id')); ?>";
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\rpa-panel\resources\views/admin/apps/edit.blade.php ENDPATH**/ ?>